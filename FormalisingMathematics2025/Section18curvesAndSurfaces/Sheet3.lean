...
/-
Heather Macbeth: This is a toy case of the inverse function theorem, but you might need to glue
together several related results. Some starting points: docs#ContDiffAt.to_localInverse,
docs#HasStrictFDerivAt.localInverse_unique
